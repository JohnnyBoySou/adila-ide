...
export const rpc = {
  ...
  setLayout: (mode: LayoutMode) =>
    call<void>("notifications.layout", { mode }),
  ...
  toggleExpand: (id: string) =>
    call<void>("notification.toggleExpand", { id }),
  clearAll: () => call<void>("notification.clearAll"),
  setCenterVisibility: (open: boolean) =>
    call<void>("notifications.centerVisibility", { open }),
  on,
};
